...
set REPO_URL "https://github.com/broli/MAterialConfirmation.git"
set TEMP_DIR "PKB_Source_Temp"
set FINAL_APP_NAME "PKB Material Confirmation System.app"
...
if not grep -q "BUNDLE(" gui_main.spec
    echo "
app = BUNDLE(
    exe,
    name='$FINAL_APP_NAME',
